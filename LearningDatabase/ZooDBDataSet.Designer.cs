...
namespace LearningDatabase {
    ...
    public partial class ZooDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ZooAnimalDataTable : global::System.Data.TypedTableBase<ZooAnimalRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ZooAnimalRow AddZooAnimalRow(int AnimalId, int ZooId) {
...
namespace LearningDatabase.ZooDBDataSetTableAdapters {
    ...
    public partial class ZooTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LearningDatabase.Properties.Settings.Default.ZooDBConnectionString;
        }
    ...
    public partial class ZooAnimalTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[ZooAnimal] WHERE (([Id] = @Original_Id) AND ([AnimalId] = @Ori" +
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[ZooAnimal] ([AnimalId], [ZooId]) VALUES (@AnimalId, @ZooId);\r\n" +
                "SELECT Id, AnimalId, ZooId FROM ZooAnimal WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[ZooAnimal] SET [AnimalId] = @AnimalId, [ZooId] = @ZooId WHERE (([Id" +
                "] = @Original_Id) AND ([AnimalId] = @Original_AnimalId) AND ([ZooId] = @Original" +
                "_ZooId));\r\nSELECT Id, AnimalId, ZooId FROM ZooAnimal WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, AnimalId, ZooId FROM dbo.ZooAnimal";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
